            ...
            <div className="flex">
              ...
              <div className="w-[60%] px-10">
                ...
                <div className="mt-5">
                  ...
                  {reqUser?.address ? (
                    <p>
                      {reqUser?.address?.postalCode}, {reqUser?.address?.street}
                      , {reqUser?.address?.city},{reqUser.address?.state},{" "}
                      {reqUser?.address?.country}
                    </p>
                  ) : (
                    <p>Address has not been updated</p>
                  )}
                </div>
                <div className="mt-5">
                  ...
                  {reqUser?.paymentDetails ? (
                    <>
                      ...
                      <p>
                        Expiration Date:{" "}
                        {reqUser?.paymentDetails?.expirationDate}
                      </p>
                    </>
                  ) : (
